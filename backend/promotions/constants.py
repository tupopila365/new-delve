...
# Display-only pricing (offline payment in v1). Prefer /products/ for live packages.
PROMOTION_PRICING = [
    ...
    {"placement": PromotionPlacement.HOMEPAGE_TRANSPORT, "label": "Homepage — Featured transport", "price_label": "N$2,000 / week", "note": "Up to 2 slots"},
