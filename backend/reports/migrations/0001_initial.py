    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_type', models.CharField(choices=[('user', 'User profile'), ('post', 'Delvers post'), ('comment', 'Comment'), ('listing', 'Listing'), ('business', 'Business'), ('message', 'Message'), ('conversation', 'Conversation'), ('accommodation_question', 'Stay question'), ('event_question', 'Event question'), ('food_question', 'Food question'), ('vehicle_question', 'Vehicle question'), ('bus_trip_question', 'Bus trip question'), ('journey', 'Journey'), ('journey_question', 'Journey question')], max_length=32)),
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['status', '-created_at'], name='reports_rep_status_7dd5e5_idx'), models.Index(fields=['target_type', 'target_id'], name='reports_rep_target__6b1f9a_idx')],
            },
        ),
    ]
