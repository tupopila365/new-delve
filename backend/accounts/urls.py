...
urlpatterns = [
    ...
    path("me/businesses/<int:pk>/offers/", MyBusinessTravelOffersView.as_view(), name="my-business-offers"),
    path(
    ...
    path(
        ...
        BusinessTravelOfferDetailView.as_view(),
        name="business-travel-offer-detail",
    ),
    path(
