...
export type MockPost = {
  ...
  guide_mgrfile?: { id: number; title: string } | null
  created_at: string
  likes_count: number
  saves_count: number
...
export const mockProfiles: Record<string, MockProfile> = {
  ...
  spam_host: {
    username: 'spam_host',
    email: 'spam@delve.local',
    user_type: 'service_provider',
    display_name: 'Cape Town Quick Deals',
    bio: 'Unverified demo seller — used to show trust ranking when expanding into new countries.',
    region: 'Western Cape',
    city: 'Cape Town',
    country_code: 'ZA',
...
export const mockStays: MockStay[] = [
  {
    ...
    latitude: -22.5609,
    longitude: 17.0658,
    formatted_address: 'Independence Ave, Windhoek, Namibia',
  ...
  },
  {
    ...
    region: 'Erongo',
    city: 'Swakopmund',
    address: 'Strand St, Swakopmund',
    latitude: -22.6783,
    longitude: 14.5261,
    formatted_address: 'Strand Street, Swakopmund, Namibia',
    price_per_night: '950',
    max_guests: 4,
    bedrooms: 2,
  ...
  },
  {
    ...
    description: 'Bright loft steps from the V&A — harbour walks, restaurants, and easy Uber hops.',
    region: 'Western Cape',
    city: 'Cape Town',
    country_code: 'ZA',
    ...
    latitude: -33.9051,
    longitude: 18.4198,
    formatted_address: 'Dock Road, V&A Waterfront, Cape Town, South Africa',
    niche_tags: ['harbour stay', 'walkable'],
  ...
  {
    id: 111,
    title: 'Bo-Kaap Courtyard Stay',
    description: 'Quiet courtyard rooms in colourful Bo-Kaap — walk to spice kitchens and Signal Hill views. Compact tiny-house feel without leaving town.',
    region: 'Western Cape',
    city: 'Cape Town',
    country_code: 'ZA',
    ...
    latitude: -33.9211,
    longitude: 18.4148,
    formatted_address: 'Chiappini Street, Bo-Kaap, Cape Town, South Africa',
    niche_tags: ['tiny house', 'courtyard', 'walkable'],
    price_per_night: '980',
    max_guests: 2,
    bedrooms: 1,
    amenities: ['wifi', 'breakfast'],
    cover_image: STAY.guesthouse,
    media_gallery: [
      { kind: 'image', src: STAY.guesthouse },
      { kind: 'image', src: STAY.bedroom },
    ],
  ...
  {
    id: 112,
    title: 'Sea Point Promenade Flat',
    description: 'Sea-facing flat on the promenade — sunrise jogs, cafés downstairs, Table Mountain on the skyline. Solar-backed off-grid backup for load-shedding nights.',
    region: 'Western Cape',
    city: 'Cape Town',
    country_code: 'ZA',
    ...
    latitude: -33.9135,
    longitude: 18.3882,
    formatted_address: 'Beach Road, Sea Point, Cape Town, South Africa',
    niche_tags: ['off-grid', 'promenade', 'family'],
    price_per_night: '1420',
    max_guests: 4,
    bedrooms: 2,
    amenities: ['wifi', 'kitchen', 'parking', 'pool'],
    cover_image: STAY.living,
    media_gallery: [
      { kind: 'image', src: STAY.living },
      { kind: 'image', src: STAY.roomView },
    ],
  ...
  {
    id: 199,
    title: 'CHEAPEST ROOM IN CAPE TOWN!!! BOOK NOW',
    description:
      'Luxury 5-star suite downtown for R99 — limited stock. Unverified spam listing used to test trust ranking.',
    region: 'Western Cape',
    city: 'Cape Town',
    country_code: 'ZA',
    address: 'Unknown',
    ...
    amenities: ['wifi'],
    cover_image: STAY.bedroom,
    media_gallery: [{ kind: 'image', src: STAY.bedroom }],
...
export const mockFood: MockFoodVenue[] = [
  {
    ...
    city: 'Windhoek',
    country_code: 'NA',
    address: 'Nelson Mandela Ave, Windhoek',
    latitude: -22.5705,
    longitude: 17.0832,
    formatted_address: 'Nelson Mandela Ave, Windhoek, Namibia',
    niche_tags: ['locals only', 'flame grill'],
    price_level: 2,
  ...
  },
  {
    ...
    region: 'Erongo',
    city: 'Swakopmund',
    address: 'Mole, Swakopmund',
    latitude: -22.6792,
    longitude: 14.5214,
    formatted_address: 'The Mole, Swakopmund, Namibia',
    price_level: 1,
  ...
  {
    id: 520,
    name: 'Waterfront Braai House',
    description: 'Harbour-facing grill with Cape Malay sides and cold local craft.',
    cuisine: 'grill',
    region: 'Western Cape',
    city: 'Cape Town',
    country_code: 'ZA',
    ...
    latitude: -33.9036,
    longitude: 18.4201,
    formatted_address: 'V&A Waterfront, Cape Town, South Africa',
    niche_tags: ['harbour dining', 'sunset table'],
    price_level: 3,
    cover_image: U.foodGrill,
    owner_username: 'food_mgr',
    rating_avg: '4.58',
    rating_count: 186,
    is_open: true,
    tagline: 'Sunset tables over the harbour.',
    popular_dish: 'Flame-grilled lamb chops',
    closes_at: '10 PM',
  },
  {
    id: 521,
    name: 'Bo-Kaap Spice Kitchen',
    description: 'Family-run Cape Malay plates — fragrant, filling, and walkable from the city bowl.',
    cuisine: 'local',
    region: 'Western Cape',
    city: 'Cape Town',
    country_code: 'ZA',
    ...
    latitude: -33.9206,
    longitude: 18.4152,
    formatted_address: 'Wale Street, Bo-Kaap, Cape Town, South Africa',
    niche_tags: ['hidden brunch', 'locals only', 'cape malay'],
    price_level: 2,
    cover_image: U.foodStreet,
    owner_username: 'food_mgr',
    rating_avg: '4.71',
    rating_count: 142,
    is_open: true,
    tagline: 'Colourful quarter, serious spice.',
    popular_dish: 'Bobotie with yellow rice',
    closes_at: '9 PM',
  },
  {
    id: 522,
    name: 'Sea Point Morning Cup',
    description: 'Beach-promenade café — espresso, fruit bowls, and early opens. Quiet hidden brunch before the promenade fills.',
    cuisine: 'cafe',
    region: 'Western Cape',
    city: 'Cape Town',
    country_code: 'ZA',
    ...
    longitude: 18.3876,
    formatted_address: 'Beach Road, Sea Point, Cape Town, South Africa',
    niche_tags: ['hidden brunch', 'breakfast', 'promenade'],
    price_level: 1,
    cover_image: U.foodCafe,
    owner_username: 'food_mgr',
    rating_avg: '4.44',
    rating_count: 97,
    is_open: true,
    tagline: 'Ocean breeze breakfasts.',
    popular_dish: 'Avo smash & flat white',
    closes_at: '3 PM',
  },
  {
    id: 599,
    name: 'BEST BRAAI IN AFRICA — 50% OFF TODAY',
    description:
      'World famous grill — free delivery everywhere. Unverified spam venue for trust ranking demos.',
    cuisine: 'grill',
    region: 'Western Cape',
    city: 'Cape Town',
    country_code: 'ZA',
    ...
    latitude: -33.922,
    longitude: 18.423,
    formatted_address: 'Cape Town CBD, South Africa',
    niche_tags: ['spam'],
    price_level: 1,
    cover_image: U.foodStreet,
    owner_username: 'spam_host',
...
export const mockGuides: MockGuide[] = [
  ...
  },
  {
    ...
    specialities: ['Food', 'Night photography', 'Niche tour', 'Hidden courtyards'],
  },
  {
    id: 604,
    user: 1,
...
export const mockPosts: MockPost[] = [
  ...
  },
  {
    id: 726,
    author: { username: 'demo_user', display_name: 'Kaoko Explorer', avatar: null },
    body: 'Anyone know a reliable local mechanic / tyre workshop near Windhoek CBD that can look at a 4x4 before a gravel trip? #mechanic #repair #transport',
    region: 'Khomas',
    place_label: 'Windhoek, Namibia',
    image: null,
    video: null,
  ...
  },
  {
    id: 727,
    author: { username: 'demo_user', display_name: 'Kaoko Explorer', avatar: null },
    body: 'Looking for a niche tour in Cape Town — something small, not the usual Table Mountain bus. Hidden courtyards or food alley walks? #capetown #niche',
    region: 'Western Cape',
    place_label: 'Cape Town, South Africa',
    image: null,
    video: null,
    delvers_board: '',
    is_delvers: false,
  ...
  },
  {
    ...
    delvers_board: '',
    is_delvers: true,
    guide_mgrfile: { id: 601, title: 'Sossusvlei & Namib desert' },
