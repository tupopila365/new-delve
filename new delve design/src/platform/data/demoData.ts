import type { ActivityItem, AdminBooking, AdminListing, AdminPayment, AdminDispute } from '../api/types'
...
export const DEMO_REPORTS: AdminReport[] = [
  { id: 1, type: 'Listing', item: 'CHEAPEST ROOM IN CAPE TOWN!!! BOOK NOW', reporter: 'demo_user', reason: 'Fake or misleading', status: 'new', date: '2026-07-20', severity: 'medium' },
  { id: 2, type: 'Listing', item: 'BEST BRAAI IN AFRICA — 50% OFF TODAY', reporter: 'anna', reason: 'Spam or misleading', status: 'escalated', date: '2026-07-21', severity: 'medium' },
...
export const DEMO_PAYMENTS: AdminPayment[] = [
  {
    id: 'shop:501',
    source: 'shop',
    source_label: 'Shop order',
    record_id: 501,
    buyer_username: 'demo_user',
    seller_username: 'maker',
    title: 'Order DLV-8F2K1',
    status: 'shipped',
    total: '120.00',
    platform_fee: '2.50',
    seller_payout: '117.50',
    payout_status: 'held',
    payout_status_label: 'Held by Delve',
    paid_at: '2026-06-01T10:00:00Z',
    payout_released_at: '',
    mock_payment_ref: 'pi_sim_demo_shop_501abcdef',
  ...
  },
  {
    ...
    record_id: 1042,
    buyer_username: 'demo_user',
    seller_username: 'stays_host',
    title: 'Freesia Hotel — Standard king room',
    status: 'confirmed',
    total: '1850.00',
    platform_fee: '185.00',
    seller_payout: '1665.00',
    payout_status: 'held',
    payout_status_label: 'Held by Delve',
    // Older than 3 days so ops aging warn is visible in mock mode
    paid_at: '2026-07-10T12:00:00Z',
    payout_released_at: '',
    mock_payment_ref: 'pi_sim_demo_stay_1042abcdef',
    created_at: '2026-05-01T10:00:00Z',
  },
  {
    id: 'guide:1043',
    ...
    record_id: 1043,
    buyer_username: 'demo_user',
    seller_username: 'guide_pro',
    title: 'Desert sunrise tour',
    status: 'completed',
    total: '650.00',
    platform_fee: '65.00',
    seller_payout: '585.00',
    payout_status: 'released',
    payout_status_label: 'Released to seller',
    paid_at: '2026-05-02T15:00:00Z',
    payout_released_at: '2026-05-14T18:00:00Z',
    mock_payment_ref: 'mock_guide_1043',
    created_at: '2026-05-02T14:00:00Z',
  },
  {
    id: 'vehicle:1044',
    source: 'vehicle',
    source_label: 'Vehicle rental',
    record_id: 1044,
    buyer_username: 'demo_user',
    seller_username: 'transport_mgr',
    ...
    payout_status: 'held',
    payout_status_label: 'Held by Delve',
    paid_at: '2026-07-17T09:00:00Z',
    payout_released_at: '',
    mock_payment_ref: 'mock_veh_1044',
    created_at: '2026-05-03T08:00:00Z',
  },
  {
    id: 'bus_seat:1045',
    source: 'bus_seat',
    source_label: 'Bus seat',
    record_id: 1045,
    buyer_username: 'demo_user',
    seller_username: 'transport_mgr',
    title: 'Windhoek → Swakopmund · seat 12',
    status: 'confirmed',
    total: '180.00',
    platform_fee: '18.00',
    seller_payout: '162.00',
    payout_status: 'held',
    payout_status_label: 'Held by Delve',
    paid_at: '2026-07-18T11:00:00Z',
    payout_released_at: '',
    mock_payment_ref: 'mock_bus_1045',
    created_at: '2026-05-04T10:00:00Z',
  },
]

export const DEMO_DISPUTES: AdminDispute[] = [
  {
    id: 1,
    source: 'shop',
    source_label: 'Shop order',
    ...
    seller_username: 'maker',
    reason: 'not_received',
    reason_label: 'Not received / no-show',
    status: 'open',
    status_label: 'Open',
    resolution: '',
    resolution_label: '',
